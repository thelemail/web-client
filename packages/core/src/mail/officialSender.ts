import { isOfficialAddress, isOfficialFingerprint } from '$core/directory/official';
import { splitMimeHeaders } from '$core/mail/render/mimeHeaders';
import { parseMailbox } from '$core/mail/address';
