<script lang="ts">
	import { theme, type ThemePref } from '$core/stores/theme.svelte';
...
<div class="scard">
	...
	<Row t="Colour mode" d="Inkwell uses deep pine, not pure black.">
		<Seg
			value={theme.pref}
			options={[
				{ v: 'light', l: 'Parchment', icon: 'sun' },
				{ v: 'dark', l: 'Inkwell', icon: 'moon' },
				{ v: 'auto', l: 'Auto', icon: 'monitor' }
			]}
