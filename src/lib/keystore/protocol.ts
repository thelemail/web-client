...
export type EncryptToKeysResponse =
  ...
  | {
      ok: false;
      code: "locked" | "invalid_recipient_key" | "no_recipients" | "unknown";
    };
...
export type CompleteLoginUnlockResponse =
  ...
  | {
      ok: false;
      code: "no_pending_login" | "proof_not_verified" | "invalid_credentials";
    };
...
export interface PreparePasswordChangeCredentialsArgs
  extends AccountScopedArgs {
  newPassword: string;
  modulus: string;
}
...
export type OpaqueCompleteLoginUnlockResponse =
  ...
  | {
      ok: false;
      code: "no_pending_operation" | "unwrap_failed" | "master_key_mismatch";
    };
